...
File: {docdir} {docname} {docfile}

asciidoctor = {asciidoctor}
present when Asciidoctor is processing the document (read-only, asciidoctor)

asciidoctor-version = {asciidoctor-version}
the version of Asciidoctor that is processing the document (read-only, asciidoctor)
...
docme (asciidoctor) (default, github, solarized_dark)
...
* link:what-is-asciidoctor.html[What is Asciidoctor?]
